...
public abstract class AssertUtils {
	...
	public static void isEmpty(String str, String message) {
	    if(StringUtils.isBlank(str)){
            throw new MessageException(HttpStatus.BAD_REQUEST,ErrorMessageMapper.CheckParamEmpty.getCode()
                    ,message + ErrorMessageMapper.CheckParamEmpty.getMessage());
		}
	}
    ...
    public static void isJsonArray(String json, String message) {
        ...
        if (!state){
            throw new MessageException(HttpStatus.BAD_REQUEST,ErrorMessageMapper.InvalidArgumentsError.getCode()
                    ,message + ErrorMessageMapper.InvalidArgumentsError.getMessage());
        }
    }
    ...
    public static JSONArray checkJsonArray(JSONObject json, String parmValue) {
        ...
        try {
            ...
            throw new MessageException(HttpStatus.BAD_REQUEST,ErrorMessageMapper.InvalidArgumentsError.getCode()
                    ,parmValue + ErrorMessageMapper.InvalidArgumentsError.getMessage());
        }
        return jsonArray;
    }
