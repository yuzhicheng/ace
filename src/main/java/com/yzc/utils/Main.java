...
public class Main {
    ...
    public static String myEmailAccount = "1799281706@qq.com";
    public static String myEmailPassword = "bckpgwehlmjhefij";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "582771729@qq.com";
