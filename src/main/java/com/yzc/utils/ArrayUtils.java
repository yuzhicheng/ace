...
public final class ArrayUtils extends org.apache.commons.lang.ArrayUtils {
    ...
    public static void main(String[] args){
    	...
    	String[] array=new String[]{"ad","ce","ga","nh","ssa","ysfs"};
    	...
    	System.out.println(ArrayUtils.join(array,separator));
    	
    	System.out.println(ArrayUtils.join(array,separator,2,array.length));
    	
    	List<String> list=ArrayUtils.asList(array);
    	list.add("yc");
