...
public class AWSClient {
    ...
    private static String AWS_ACCESS_KEY = "AKIAIJG67MIKHMI3R2QQ";//AKIAIYIWSCNX622IJ65A,AKIAIJG67MIKHMI3R2QQ

    private static String AWS_SECRET_KEY = "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";//ZoW4XECSgucGrBpDdtx+EtxkVPKYq5Rx+I3+wcvV,y/aSovRkJ5ubpSSKXdYfLjnEepigceSL/kVbnm3f
    
    static final String bucketName = "yzc";
    /**
     * 通过default方法连接aws
     * @author yzc
     * @date 2017年4月6日 
    ...
    public static void main(String[] args) throws Exception {
        ...
        createSampleFile(bucketName,"D:\\桌面\\a.txt");
        showContentOfAnObject(bucketName,"a.txt");
        listBuckets();
