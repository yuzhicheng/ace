 ...
 */
public class ResEducationalModel {
	...
	/**
	 * 学习对象的具体类型。越主要的类型越先列出。  媒体素材 试题 试卷 课件 文献资料 教学案例 常见问题解答 资源目录索引 网络课程
	 * 根据业务的细分化，当前的资源的类型还需要进行更进一步的划分
	 */
