package com.yzc.support.annotation.impl;
...
public class RegValidator implements ConstraintValidator<Reg, String>{
	...
	private static String getPropertyValue(String key){
		...
		try {
			...
			throw new WafSimpleException(ErrorMessageMapper.RegValidationFail.getCode(),ErrorMessageMapper.RegValidationFail.getMessage());
		}
