...
public class HomeController {
    ...
    public ResponseEntity<StudentViewModel> createStudent(@Valid @RequestBody StudentViewModel svm, BindingResult validResult, UriComponentsBuilder ucb) {
        ...
        URI locationUri = ucb.path("/home/create").build().toUri();
        headers.setLocation(locationUri);
        return new ResponseEntity<>(changeToViewModel(sm), headers, HttpStatus.CREATED);
    }
    ...
    public
    @ResponseBody
    StudentViewModel updateStudent(@PathVariable String id, @Valid @RequestBody StudentViewModel studentViewModel, BindingResult validResult) {
